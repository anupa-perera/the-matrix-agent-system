...
class MemoryVault:
    ...
    def _mission_task_lines(self, task: MissionTask) -> list[str]:
        return [
            ...
            "",
            f"{self._markdown_list(task.required_capabilities)}",
            "",
            "Expected outputs:",
            "",
            f"{self._markdown_list(task.expected_outputs)}",
            "",
            "Completion checks:",
            "",
            f"{self._markdown_list(task.completion_checks)}",
            "",
            "User actions:",
            "",
            f"{self._markdown_list(task.user_actions)}",
            "",
            task.description,
            "",
            "Result:",
